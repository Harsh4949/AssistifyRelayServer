...
public class NetworkBufferedSender {
    ...
    public  static String requiredRoot = "api/v1/incoming-sms";
        ...
        apiService.sendTransaction(requiredRoot, data).enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.d(TAG, (fromBuffer ? "Sent from buffer: " : "Sent live: ") + data.getBody());
            ...
            apiService.sendTransaction(requiredRoot, data).enqueue(new Callback<Void>() {
                ...
                public void onResponse(Call<Void> call, Response<Void> response) {
                    if (response.isSuccessful()) {
                        ...
                        Log.d(TAG, "Sent from buffer: " + data.sessionId);
                    } else {
